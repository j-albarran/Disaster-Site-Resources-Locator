...
class AccountHandler:
    ...
    def getAccountsOnThisrname(self, rname):
       return 'Showing accounts on rname: %s' %(rname)
    ...
    def searchAccounts(self, args):
        ...
        # ------------------------------------------------------------------------------
            ...
            return 'Looking for accounts by username and rname'

        elif(len(args) == 2) and email and rname:
            return 'Looking for accounts by email and rname'

        elif(len(args) == 2) and cname and rname:
            return 'Looking for accounts by cname and rname'

        elif(len(args) == 2) and lastName and rname:
            return 'Looking for accounts by plname and rname'

        elif(len(args) == 2) and firstName and rname:
            return 'Looking for accounts by pname and rname'

        elif(len(args) == 2) and username and rname:
            return 'Looking for accounts by username and rname'

        elif(len(args) == 2) and email and username:
            return 'Looking for accounts by email and username'

        elif(len(args) == 2) and cname and username:
            return 'Looking for accounts by cname and username'

        elif(len(args) == 2) and lastName and username:
            return 'Looking for accounts by plname and username'

        elif(len(args) == 2) and firstName and username:
            return 'Looking for accounts by pname and username'

        elif(len(args) == 2) and cname and email:
            return 'Looking for accounts by cname and email'

        elif(len(args) == 2) and lastName and email:
            return 'Looking for accounts by plname and email'

        elif(len(args) == 2) and firstName and email:
            return 'Looking for accounts by pname and email'

        elif(len(args) == 2) and lastName and cname:
            return 'Looking for accounts by plname and cname'

        elif(len(args) == 2) and firstName and cname:
            return 'Looking for accounts by pname and cname'

        elif(len(args) == 2) and firstName and lastName:
            return 'Looking for accounts by pname and plname'

        # ------------------------------------------------------------------------------

        # firstname
        elif (len(args) == 1) and firstName:
            return 'Looking for accounts by pname'

        # lastname
        elif (len(args) == 1) and lastName:
            return 'Looking for accounts by plname'

        # cname
        elif (len(args) == 1) and cname:
            return 'Looking for accounts by cname'

        # email
        elif (len(args) == 1) and email:
            return 'Looking for accounts by email'

        # username
        elif (len(args) == 1) and username:
            return 'Looking for accounts by username'

        # rname
        elif (len(args) == 1) and rname:
            return 'Looking for accounts by rname'
        # ------------------------------------------------------------------------------

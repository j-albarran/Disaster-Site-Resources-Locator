...
class AdministratorHandler:
    ...
    def getAdministratosOnThisrname(self, rname):
       return 'Showing administratos on rname: %s' %(rname)
    ...
    def searchAdministrators(self, args):
        ...
        # ------------------------------------------------------------------------------
            ...
            return 'Looking for administrators by username and rname'

        elif (len(args) == 2) and email and rname:
            return 'Looking for administrators by email and rname'

        elif (len(args) == 2) and cname and rname:
            return 'Looking for administrators by cname and rname'

        elif (len(args) == 2) and lastName and rname:
            return 'Looking for administrators by plname and rname'

        elif (len(args) == 2) and firstName and rname:
            return 'Looking for administrators by pname and rname'

        elif (len(args) == 2) and username and rname:
            return 'Looking for administrators by username and rname'

        elif (len(args) == 2) and email and username:
            return 'Looking for administrators by email and username'

        elif (len(args) == 2) and cname and username:
            return 'Looking for administrators by cname and username'

        elif (len(args) == 2) and lastName and username:
            return 'Looking for administrators by plname and username'

        elif (len(args) == 2) and firstName and username:
            return 'Looking for administrators by pname and username'

        elif (len(args) == 2) and cname and email:
            return 'Looking for administrators by cname and email'

        elif (len(args) == 2) and lastName and email:
            return 'Looking for administrators by plname and email'

        elif (len(args) == 2) and firstName and email:
            return 'Looking for administrators by pname and email'

        elif (len(args) == 2) and lastName and cname:
            return 'Looking for administrators by plname and cname'

        elif (len(args) == 2) and firstName and cname:
            return 'Looking for administrators by pname and cname'
        ...
        # cname
            ...
            return 'Looking for administrators by cname'

        # email
        elif (len(args) == 1) and email:
            return 'Looking for administrators by email'

        # username
        elif (len(args) == 1) and username:
            return 'Looking for administrators by username'

        # rname
        elif (len(args) == 1) and rname:
            return 'Looking for administrators by rname'
        # ------------------------------------------------------------------------------
